		...
		stage('CheckOut and Build The Application')
		{
			...
			{ 
				success 
				{
					...
					sh 'cp target/*.war /home/kovair/Appwar_GitHub'
					//echo '************ Pushing the war files to https://github.com/prasenjitkovair/war-repository.git ************' 
				    sh '''
				        cd /home/kovair/Appwar_GitHub
